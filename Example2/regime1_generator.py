...
def f(x,a):
    if (a==1):
        ...
        return F0_2@x
S0_1=np.array([[1,0.3],[0,1]])
S0_2=np.array([[1,0],[0,1]])
def s(x,a):
    if (a==1):
        return S0_1
    else:
...
f1=gzip.open('../Temp/Datav2/Regime1Train4.pklz','wb')
f2=gzip.open('../Temp/Datav2/Regime1New4.pklz','wb')
pickle.dump(obj1, f1)
pickle.dump(obj2,f2)
f1.close()
f2.close()
