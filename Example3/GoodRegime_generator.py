...
F0=np.array([[0.3,0.5],[0,0.3]])
G0=np.array([[0.7,-0.3],[0,0.7]])
H0=np.array([[1,0],[0,1]])
x0=np.array([[1],[-1]])
...
f1=gzip.open('../Temp/Datav2/GoodRegimeTrain4.pklz','wb')
f2=gzip.open('../Temp/Datav2/GoodRegimeNew4.pklz','wb')
pickle.dump(obj1, f1)
pickle.dump(obj2, f2)
f1.close()
f2.close()