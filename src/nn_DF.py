...
class Network(object):
    ...
    # def SGD_BatchAdalr(self, training_data, epochs, mini_batch_size, learning_rate, epi, alpha, seed=True,evaluation_data=None):
    #     """Mini batch gradient descent with adaptive learning rate based on mini-batch."""
    #     print("-----------------------------")
    #     print("Batch Adaptive lr begins.")
    #     self.params_initializer()
    #     self.eta=learning_rate
    #     print("Initial eta is: {0}".format(learning_rate))
    #     if evaluation_data: n_evaluation = len(evaluation_data)
    ...
    #         for mini_batch in mini_batches:
    #             nabla_b, nabla_w=self.mini_batch_gradients(mini_batch)
    #             nabla_eta=self.learning_rate_gradient(mini_batch, nabla_b, nabla_w, epi, alpha)
    #             #print("nabla_eta is: {0}".format(nabla_eta))
    #             self.update_weights(nabla_b, nabla_w)
    #             self.eta=self.eta-epi*nabla_eta

    #         training_cost.append(self.total_cost(training_data))
    #         evaluation_cost.append(self.total_cost(evaluation_data, convert=False))
    #         lr.append(self.eta)
    #         print("The eta of Epoch {0} is {1}".format(epoch, self.eta))
    #         if evaluation_data:
    #             print("Epoch {0}: {1}".format(epoch, evaluation_cost[-1]))
    #         else:
    #             print ("Epoch {0} complete".format(epoch))
    #     return training_cost,evaluation_cost,self.weights, self.biases, lr
    ...
    # def SGD_Avg(self, training_data, epochs, mini_batch_size, learning_rate, seed=True, evaluation_data=None):
    #     """SGD with averaing method"""
    #     print("-----------------------------")
    #     print("SGD with averaging only begins.")
    #     self.params_initializer()
    #     self.eta=learning_rate
    #     print("Initial eta is: {0}".format(learning_rate)) 
    ...
    #     # count the step size
    #     itr=0
    #     avg_weights=self.weights; avg_biases=self.biases #\Theta_0
        
    #     if seed: random.seed(1233)
    #     for epoch in range(epochs):
    #         random.shuffle(training_data)
    #         mini_batches=[training_data[k:k+mini_batch_size] for k in range(0,n, mini_batch_size)]
    #         for mini_batch in mini_batches:
    #             itr=itr+1
    #             nabla_b, nabla_w=self.mini_batch_gradients(mini_batch)
    #             # compute \theta_n. \theta_1 <--- \theta_0
    #             self.update_weights(nabla_b, nabla_w)
    #             # compute \Theta_n
    #             avg_weights=[avgw-avgw/(1+itr)+w/(1+itr) for avgw, w in zip(avg_weights, self.weights)]  #\Theta_1 <-- \Theta_0
    #             avg_biases=[avgb-avgb/(1+itr)+b/(1+itr) for avgb, b in zip(avg_biases, self.biases)]
            
    #         lr.append(self.eta)
    #         print("The eta of Epoch {0} is {1}".format(epoch, self.eta))
    #         training_cost.append(self.total_cost(training_data, avg_weights, avg_biases))
    #         evaluation_cost.append(self.total_cost(evaluation_data, avg_weights, avg_biases,convert=False))   
    #         if evaluation_data:
    #             print("Epoch {0}: {1}".format(
    #                 epoch, evaluation_cost[-1]))
    #         else:
    #             print ("Epoch {0} complete".format(epoch))

    #     return training_cost, evaluation_cost,self.weights, self.biases, avg_weights, avg_biases, lr

    # def SGD_Dec(self, training_data, epochs, mini_batch_size, learning_rate, seed=True, evaluation_data=None):
    #     """Decreasing lr in SA algorithm"""
    #     print("-----------------------------")
    #     print("Decreasing lr in SA begins.")
    #     self.params_initializer()
    #     self.eta=learning_rate
    #     print("Initial eta is: {0}".format(learning_rate)) 
    #     if evaluation_data: n_evaluation = len(evaluation_data)
    ...
    # def SGD_AvgDec(self, training_data, epochs, mini_batch_size, learning_rate,seed=True, evaluation_data=None):
    #     """Decreasing lr with averaging method"""
    #     print("-----------------------------")
    #     print("Decreasing with averaging begins.")
    #     self.params_initializer()
    #     self.eta=learning_rate
    #     print("Initial eta is: {0}".format(learning_rate)) 
    ...
    def SGD_TimeBasedlr(self, training_data, epochs, mini_batch_size, learning_rate, decay_rate,\
                        monitor_cost=True, seed=True, evaluation_data=None):
        """Time based Learning rate."""
        print("------------------------------")
        print("Time based learning rate begin.")
        self.params_initializer()
        self.eta=learning_rate
        ...
        training_relerr=[]; evaluation_relerr=[]
        lr=[];lr.append(learning_rate)
        print("Initial eta is: {0}".format(self.eta))
        if seed: random.seed(4)
        for epoch in range(epochs):
            random.shuffle(training_data)
            mini_batches=[training_data[k:k+mini_batch_size] for k in range(0,n, mini_batch_size)]
            for mini_batch in mini_batches:
            ...
            self.eta=self.eta/(1+decay_rate*epoch)
            lr.append(self.eta)
            print("The eta of Epoch {0} is {1}".format(epoch, self.eta))
    ...
    def SGD_StepBasedlr(self, training_data, epochs, mini_batch_size, learning_rate, decay_rate, drop_rate,\
                        monitor_cost=True, seed=True, evaluation_data=None):
        """Step based learning rate"""
        print("-----------------------------")
        print("Step based learning rate begin.")
        self.params_initializer()
        self.eta=learning_rate
        print("Initial eta is: {0}".format(learning_rate))
        if evaluation_data: n_evaluation = len(evaluation_data)
        ...
        for epoch in range(epochs):
            ...
            for mini_batch in mini_batches:
                nabla_b, nabla_w=self.mini_batch_gradients(mini_batch)
                self.update_weights(nabla_b, nabla_w)
            self.eta=learning_rate*(decay_rate ** np.floor((1+epoch)/drop_rate))
            lr.append(self.eta)
            print("The eta of Epoch {0} is {1}".format(epoch, self.eta))
    ...
    def SGD_ExpBasedlr(self, training_data, epochs, mini_batch_size, learning_rate, decay_rate,\
                       monitor_cost=True, seed=True, evaluation_data=None):
        print("-----------------------------")
        print("Exponential based learning rate begin.")
        self.params_initializer()
        self.eta=learning_rate
        ...
        for epoch in range(epochs):
            ...
            for mini_batch in mini_batches:
                nabla_b, nabla_w=self.mini_batch_gradients(mini_batch)
                self.update_weights(nabla_b, nabla_w)
            self.eta=learning_rate*np.exp(-decay_rate*epoch)
            lr.append(self.eta)
            print("The eta of Epoch {0} is {1}".format(epoch, self.eta))
            if monitor_cost:
                tc_mseErr, tc_relErr=self.total_cost(training_data)
    ...
    def learning_rate_gradient(self, mini_batch, nabla_b, nabla_w, epi, alpha, modified=False):
        ...
        'modified' concerns whether to perturb on both sides. It is true means that we
